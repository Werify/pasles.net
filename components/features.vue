    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div
        ...
        <div class="border p-4 px-7 rounded-2xl">
          ...
          <h3 class="mb-2 text-lg font-semibold dark:text-white">Marketing</h3>
          <p class="text-gray-700 text-sm mb-4 dark:text-gray-400">
        ...
        <div class="border p-4 px-7 rounded-2xl">
          ...
          <h3 class="mb-2 text-lg font-semibold dark:text-white">Legal</h3>
        ...
        <div class="border p-4 px-7 rounded-2xl">
          ...
          <h3 class="mb-2 text-lg font-semibold dark:text-white">Finance</h3>
          <p class="text-gray-500 text-sm dark:text-gray-400">
        ...
        <div class="border p-4 px-7 rounded-2xl">
          ...
          <h3 class="mb-2 text-lg font-semibold dark:text-white">Operations</h3>
          <p class="text-gray-500 text-sm dark:text-gray-400">
